    ...
    <div class="container">
        ...
        <div id="navbarMenu" class="navbar-menu">
            <div class="navbar-end">
                <a class="navbar-item is-active" href="<?=base_url('home')?>" >Home</a>
                <a class="navbar-item" href="<?=base_url('produtos')?>">Produtos</a>
                <a class="navbar-item" href="<?=base_url('contato')?>">Contato</a>
                <a class="navbar-item" href="<?=base_url('admin')?>">Adm</a>
            </div>
        </div>
    </div>
</nav>
