            ...
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    ...
                    <div class="box">
                        ...
                        <form action='?controller=users&action=validateLogin' method="POST">
                            <div class="field">
                                <div class="control">
                                    <input class="input is-large" name="login" type="text" placeholder="Seu usuário" autofocus="">
                                </div>
                            </div>

                            <div class="field">
                                <div class="control">
                                    <input class="input is-large" name="password" type="password" placeholder="Sua senha">
                                </div>
                            </div>
                            <div class="field">
                            </div>
